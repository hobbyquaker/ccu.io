...
function every_minute() {
    scheduler.scheduleJob("* * * * *", function () {
        ...
        if (azimuth > -112.5 && azimuth < -67.5) {
            _position = 1;
        } else if (azimuth > -67.5 && azimuth < -22.5) {
            _position = 1;
        } else if (azimuth > -22.5 && azimuth < 22.5) {
            _position = 1;
        } else if (azimuth > 22.5 && azimuth < 67.5) {
            _position = 1;
        } else if (azimuth > 67.5 && azimuth < 112.5) {
            _position = 1;
        } else if (azimuth < 0 && altitude < AdapterSettings.Morgendaemmerung) {
            day_night = 1; //Nacht
        ...
        var _now = now.getHours + ":" + now.getMinutes;
        var daytime = 0;
        if (AdapterSettings.Fruehmorgen == _now) {
            daytime = 1;
        } else if (AdapterSettings.Morgen == _now) {
            daytime = 1;
        } else if (AdapterSettings.Vormittag == _now) {
            daytime = 1;
        } else if (AdapterSettings.Mittag == _now) {
            daytime = 1;
        } else if (AdapterSettings.Nachmittag == _now) {
            daytime = 1;
        } else if (AdapterSettings.Abend == _now) {
            daytime = 1;
        } else if (AdapterSettings.Spaetabend == _now) {
            daytime = 1;
        }
